 ...
 *
 * Purpose:
 * Extra scaffolding functions for the payload_if_app unit test
 *
 * Notes:
...
#ifndef UT_PAYLOAD_IF_APP_H
#define UT_PAYLOAD_IF_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "PAYLOAD_IF_APP_Data_t" typedef.
 */
#include "payload_if_app.h"

/*
 * Allow UT access to the global "PAYLOAD_IF_APP_Data" object.
 */
// extern PAYLOAD_IF_AppData_t PAYLOAD_IF_APP_Data;

#endif /* UT_PAYLOAD_IF_APP_H */
