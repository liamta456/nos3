module Components {
    ...
    active component Payload_ifSim {
        ...
        @ Command to initialize Sequence Payload_if HK
        async command PAYLOAD_IF_SEQ(
        )
        ...
        @ A Count of Successful Commands from FSW to Payload_if
        telemetry CommandCount: U32

        @ A Count of Unsuccessful Commands from FSW to Payload_if
